...
def validate_with_synthetic_dataset():
    ...
    dataset_filepath = SurealConfig.resource_path('dataset', 'NFLX_dataset_public_raw_last4outliers.py')
    np.random.seed(0)
...
def run_datasize_growth(dataset_filepaths):
    ...
    @persist_to_file(SurealConfig.workdir_path('_run_subject_nums.json'))
...
def run_subject_corruption_growth(dataset_filepaths):
    ...
    @persist_to_file(SurealConfig.workdir_path('_run_corrupt_nums.json'))
...
def run_missing_growth(dataset_filepaths):
    ...
    @persist_to_file(SurealConfig.workdir_path('_run_missing_probs.json'))
...
def run_subject_partial_corruption_growth(dataset_filepaths):
    ...
    @persist_to_file(SurealConfig.workdir_path('_run_partial_corrupt_nums.json'))
...
def main():
    ...
    dataset_filepaths = [
        SurealConfig.resource_path('dataset', 'NFLX_dataset_public_raw_last4outliers.py'),
